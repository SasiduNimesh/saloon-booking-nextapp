...
const AddBeautyService = ({ setShowForm , onServiceAdded }: { setShowForm: (show: boolean) => void; onServiceAdded: () => void; }) => {
  const [formData, setFormData] = useState({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (response.ok) {
            alert("Beauty service added successfully!");
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black opacity-85">
      <div className="bg-white p-6 rounded-lg w-96 shadow-lg">
        <h2 className="text-xl font-bold mb-4">Add New Beauty Service</h2>
...
export default AddBeautyService