...
const BookContact = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-green-200 to-violet-200 py-12 px-6">
      <div className="max-w-3xl mx-auto text-center" data-aos="zoom-in-up">
        <div className="mb-6">
      ...
      <div className="mt-12 text-center grid grid-cols-1 md:grid-cols-3 gap-6" data-aos="zoom-in-down">
