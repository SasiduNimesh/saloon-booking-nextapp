  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-8">
        <div className="flex items-center justify-center w-full mb-6 space-x-6">
            ...
            <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500" data-aos="fade-left">
            Services
            </h2>
            <div className="border-t-2 border-amber-600 w-1/4"></div>
        </div>
      <div className="max-w-4xl w-full p-6 rounded-lg shadow-md border-2 border-amber-600 mt-6" data-aos="fade-right">
